(() => {
    ...
    const heroMove = document.querySelector(".stages__hero");
    scroller.addEventListener("wheel", (function(e) {
        ...
        scroller.scrollLeft += scrollSpeed * scrollDirection * 1.1;
        let scrollLeft = Math.round(scroller.scrollLeft);
        let maxScrollLeft = Math.round(scroller.scrollWidth - scroller.clientWidth);
        if (-1 === scrollDirection && scrollLeft > 0 || 1 === scrollDirection && scrollLeft < maxScrollLeft) e.preventDefault();
        return true;
    }), false);
    isWebp();
})();